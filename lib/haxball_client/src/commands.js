...
var commands = {
  ...
  "!enablechat": {
    description: "Habilitar el chat log",
    func: function(player) {
      chatLog.enable();
      room.sendAnnouncement(`${e("redExclamationMark")} ${player.name} habilito el chat log`);
    }
  },
  "!disablechat": {
    description: "Deshabilitar el chat log",
    func: function(player) {
      chatLog.disable();
      room.sendAnnouncement(`${e("redExclamationMark")} ${player.name} deshabilito el chat log`);
    }
  }
}
